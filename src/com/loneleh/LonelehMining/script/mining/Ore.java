...
public class Ore
{
	...
	public int[] getRockGroupIds(String location, OreType type)
	{
		...
		else if (location.equalsIgnoreCase(MiningLocation.LUMBRIDGE_SWAMP_W.getName()))
		{
			switch (type)
			{
			case TIN:
		...
		else if (location.equalsIgnoreCase(MiningLocation.MINING_GUILD.getName()))
		{
			...
			case SILVER:
				return new int[]{};
			case COAL:
				return new int[]{5770, 5771, 5772};
			case GOLD:
				return new int[]{};
			case MITHRIL:
				return new int[]{5784, 5785, 5786};
			case ADAMANT:
				return new int[]{};
			case RUNE:
				return new int[]{};
		...
		else if (location.equalsIgnoreCase(MiningLocation.MINING_GUILD_RD.getName()))
		{
			switch (type)
			{
			case TIN:
		...
		else if (location.equalsIgnoreCase(MiningLocation.DWARVEN_HIDDEN_MINE.getName()))
		{
			switch (type)
			{
			case TIN:
			...
			case IRON:
				return new int[]{};
			case SILVER:
				return new int[]{29224, 29225, 29226};
			case COAL:
				return new int[]{32426, 32427, 32428};
			case GOLD:
				return new int[]{};
			case MITHRIL:
				return new int[]{32438, 32439, 32440};

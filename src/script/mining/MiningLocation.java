...
public enum MiningLocation
{
	...
	{
		if (loc.equalsIgnoreCase("al kharid"))
		{
	...
	public static TilePath getMinesToBankPath(String loc)
	{
		if (loc.equalsIgnoreCase("al kharid"))
		{
			...
			//new Tile[]{new Tile(3300, 3315, 0), new Tile(3300, 3319, 0), new Tile(3300, 3305, 0), new Tile(3299, 3300, 0), new Tile(3299, 3293, 0), new Tile(3299, 3286, 0), new Tile(3300, 3280, 0), new Tile(3296, 3273, 0), new Tile(3295, 3266, 0), new Tile(3292, 3254, 0), new Tile(3291, 3240, 0), new Tile(3283, 3232, 0), new Tile(3278, 3226, 0), new Tile(3280, 3218, 0), new Tile(3284, 3210, 0), new Tile(3282, 3202, 0), new Tile(3281, 3194, 0), new Tile(3280, 3186, 0), new Tile(3276, 3179, 0), new Tile(3275, 3172, 0), new Tile(3273, 3166, 0), new Tile(3271, 3168, 0)});
		}
		else if (loc.equalsIgnoreCase("lumbridge swamp"))
		{
